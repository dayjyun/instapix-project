...
//   following &&
//     (following = Object.values(following)?.map(
//       (following) => following?.follower_info?.id
//     ));
...
//                         </a>
//                         <div>
//                           <PostCardModal post={post} randomPost={post} />
//                         </div>
//                       </div>
...
//                         <FeedPostModalCommentBtn post={post} />
//                       </div>
//                       <TotalLikesComponent
//                         post={post}
//                         setCurrPostState={setCurrPostState}
//                       />
//                       {/* {post?.num_likes} */}
...
//                         <FeedPostModalViewStr post={post} />
//                       </div>
//                       <div className="feed-post-date">
//                         {getCreatedDate(post?.created_at)}
//                       </div>
...
//                   © 2022 INSTAPIX FROM FELIPE SALLY JAN KEVIN HUYDU
//                 </p>
//               </div>
//             </div>
//           </div>
