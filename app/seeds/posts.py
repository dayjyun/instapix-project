...
def seed_posts():
    ...
    post10 = Post(
        user_id=5, caption="People say 'go big or go home' like going home is a bad thing. Heck yeah, I want to go home, and I'll have a nap when I get there.", post_url='https://images4.fanpop.com/image/photos/21300000/wallpaper-random-21343049-1280-800.jpg')
    post11 = Post(
        user_id=5, caption="Don't talk to me until I've had my morning coffee.", post_url='https://i.pinimg.com/736x/ed/36/8f/ed368fce6a450f3b81d836eb564d88a7.jpg')
    post12 = Post(
        user_id=5, caption="Catch flights, not feelings.", post_url='https://i.ytimg.com/vi/WJZIJ4XSQ-Q/maxresdefault.jpg')
    post13 = Post(
        user_id=5, caption='I am the worst thing ever happen to you if you poked me badly.', post_url='https://getwallpapers.com/wallpaper/full/c/0/0/733257-random-funny-wallpapers-1920x1200-720p.jpg')
    post14 = Post(
    ...
    post15 = Post(
        user_id=5, caption='No man can be wise on an empty stomach.', post_url='https://images2.fanpop.com/images/photos/4600000/Nature-random-4633436-1280-800.jpg')
    post16 = Post(
        user_id=5, caption='Looking like your neighborhood soccer mom. #felipeSilva916', post_url='https://images5.fanpop.com/image/photos/31600000/Cool-Wallpaper-random-31687536-1920-1200.jpg')
    post17 = Post(
        user_id=5, caption="I know looks aren't everything, but I have them just in case.", post_url='https://getwallpapers.com/wallpaper/full/4/6/5/733314-random-funny-wallpapers-2048x1536-smartphone.jpg')
    post18 = Post(
        user_id=5, caption="Doing nothing is hard, you never know when you're done.", post_url='http://1.bp.blogspot.com/_EAViqbzwc_s/TJ3wMeIOSZI/AAAAAAAABNM/0U9mcf2AYeA/s1600/Random%2Bwallpapers%2B(6).jpg')
    post19 = Post(
